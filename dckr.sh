...
dckr__man_1_edit_main="Edit main scriptfiles. "
...
dckr__man_1_edit_local="Edit project files. "
...
dckr__man_1_ps="List processes for current project"
dckr__ps()
{
  dckr_p_ctx "$@"
  ${sudo}docker ps
...
dckr__man_1_register="Register a project with dckr build package metadata. "
...
dckr__man_1_init_sickbeard="Rebuild sickbeard at 8008"

...
python. Slow and memory intensive, mostly for testing and verification.

The constants and routine are cribbed from the POSIX man page

:src: https://stackoverflow.com/questions/6835381/python-equivalent-of-unix-cksum-function
:also: https://blog.box.com/blog/crc32-checksums-the-good-the-bad-and-the-ugly/
"""
